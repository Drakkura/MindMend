...
<body>
    ...
    <div class="dash-body">
        ...
        <table border="0" width="100%" style="border-spacing: 0;margin: 0;padding: 0;margin-top: 25px;">
            <tr>
                <td>
                    <form action="{{ route('patient.searchDoctor') }}" method="GET" class="header-search"
                        ...
                        <div class="table-session scroll">
                            <table width="93%" class="sub-table scrolldown" border="0"
                                ...
                                @if ($hasSearchResults)
                                    <thead>
                                        <tr>
                                            <th class="table-headin" style="color: #BACAE1;">Doctor Name</th>
                                            <th class="table-headin" style="color: #BACAE1;">Email</th>
                                            <th class="table-headin" style="color: #BACAE1;">Specialties</th>
                                            <th class="table-headin" style="color: #BACAE1;">Events</th>
                                        </tr>
                                    </thead>
                                @endif
                                <tbody>
                                    @foreach ($doctors as $doctor)
                                        <tr>
                                            <td style="color: white; text-align: center">{{ $doctor->pname }}</td>
                                            <td style="color: white; text-align: center">{{ $doctor->pemail }}</td>
                                            <td style="color: white; text-align: center">{{ $doctor->specialties }}</td>
                                            <td>
                                                <div style="display: flex; justify-content: center;">
                                                    <button class="btn btn-primary button-icon btn-view"
                                                        style="padding-left: 40px; padding-top: 12px; padding-bottom: 12px; margin-top: 10px;"
                                                        data-toggle="modal" data-target="#doctorModal{{ $doctor->docid }}">
                                                        View Details
                                                    </button>
                                                </div>
                                            </td>
                                        ...
                                        <!-- Modal Detail Dokter -->
                                        <div class="modal fade" id="doctorModal{{ $doctor->docid }}" tabindex="-1"
                                            aria-labelledby="doctorModalLabel{{ $doctor->docid }}" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>
                                                            <strong>Name:</strong> {{ $doctor->pname }}
                                                            <br>
                                                            <strong>Email:</strong> {{ $doctor->pemail }}
                                                            <br>
                                                            <strong>Phone Number:</strong> {{ $doctor->ptel }}
                                                            <br>
                                                        </p>
                                                    </div>
