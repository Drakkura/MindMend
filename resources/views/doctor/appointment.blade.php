    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="{{ route('doctor.appointment') }}">Bookings</a>
                </li>
                <li class="nav-item">
        ...
        <table border="0" width="100%" style="border-spacing: 0; margin: 0; padding: 0; margin-top: 0px;">
            <tr>
                <td colspan="4" style="padding-top: 0px; width: 100%;">
                    <center>
                        <table class="filter-container" border="0" style="background-color: #161c2d; border-radius: 10px; padding: 10px; width: 1000px;">
                            <tr>
                                <td width="10%">
                                ...
                                <td width="25%">
                                    <form action="{{ route('doctor.appointment') }}" method="get">
                                        <input type="date" name="scheduledate" id="date" class="input-text filter-container-items" style="margin: 0; width: 75%;">
                                </td>
                                ...
                                <tbody>
                                    @if ($appointments->isEmpty())
                                        <tr>
                                            <td colspan="7">
                                                ...
                                                <center>
                                                    <br>
                                                    <p class="heading-main12" style="margin-left: 45px; font-size: 20px; color: white;">
                                                        Not Found!
                                                    </p>
                                                </center>
                                                <br><br><br><br>
                                    ...
                                    @else
                                        @foreach ($appointments->groupBy('appodate') as $date => $appointmentsOnDate)
                                            <tr>
                                                <td colspan="4">
                                                    <p class="heading-main12" style="margin-left: 45px; font-size: 18px; color: #BACAE1;">
                                            ...
                                            <tr>
                                                @foreach ($appointmentsOnDate as $appointment)
                                                    <td class="dashboard-items search-items" style="background-color: #161c2d;">
                                                        <div style="width: 100%;">
                                                            <div class="h3-search">
                                                            ...
                                                            <div class="h3-search">
                                                                @if ($appointment->schedule)
                                                                    Doctor: {{ $appointment->schedule->doctor->docname }}
                                                                @endif
                                                            </div>
                                                            <div class="h4-search">
                                                                Scheduled Date: {{ $appointment->schedule->scheduledate }}<br>
                                                                Starts: <b>{{ $appointment->schedule->scheduletime }}</b> (24h)
                                                            </div>
                                                            <br>
                                                            <a href="{{ route('patient.cancelAppointment', $appointment->appoid) }}">
                                                                <button class="btn btn-primary" style="padding-top: 11px; padding-bottom: 11px; width: 100%">
                                                                    Cancel Booking
                                                                </button>
                                                            </a>
                                                        </div>
